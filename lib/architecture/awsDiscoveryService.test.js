...
function fixture({ deploymentResources, inventory } = {}) {
  ...
  return {
    database,
    calls,
    service: new ArchitectureAwsDiscoveryService({ deploymentReader, inventoryReader, relationshipReader, graphService }),
  };
}
