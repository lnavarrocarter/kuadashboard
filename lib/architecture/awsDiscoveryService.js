...
function normalizePreview({ profileId, region, accountId, stackNames, resources, relationships = [], failures = [], estimate }) {
  ...
  return {
    ...
    relationshipAnalysis: {
      ...
      supportedEvidence: ['cloudformation_reference', 'aws_inventory', 'eventbridge_target', 'asl_reference'],
      failures,
    },
    estimate,
  };
...
module.exports = { ArchitectureAwsDiscoveryService, identifyApplications, mergeResources, normalizePreview };