 ...
 *
 * Categories: kubernetes | aws | gcp | vercel | architecture | helm | envManager | localShell | system
 ...
 *
 * @param {object} params
 * @param {string} params.category  - kubernetes | aws | gcp | architecture | helm | envManager | localShell | system
...
function log({ category, action, resource = '', details = {}, level = 'info', context = '' }) {
  const VALID_CATEGORIES = ['console', 'kubernetes', 'aws', 'gcp', 'architecture', 'helm', 'envManager', 'localShell', 'system'];
