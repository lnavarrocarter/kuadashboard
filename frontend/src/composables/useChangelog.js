...
export const CHANGELOG = [
  {
    ...
    items: [
      ...
      { type: 'new',    text: 'Diagrama APL por evento — recorridos EventBridge a SQS y Lambda ordenados por entrada, ruta y etapa, con evidencia de bus, patrón y programación' },
