---
title: Primeros Pasos con el Dashboard Kubernetes KUA
description: Instala y configura KUA, el dashboard open source para operar Kubernetes, AWS y GCP desde una sola plataforma.
---
